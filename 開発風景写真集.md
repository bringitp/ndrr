# day 17  f"ab -n 1000 -c 10 -H 'Authorization: {headers['Authorization']}' {url}"
```
local (avatarに若干バグあり。
...
Total transferred:      210996 bytes
HTML transferred:       45975 bytes
Requests per second:    127.01 [#/sec] (mean)
Time per request:       78.734 [ms] (mean)
Time per request:       7.873 [ms] (mean, across all concurrent requests)
Transfer rate:          26.17 [Kbytes/sec] received

Connection Times (ms)
              min  mean[+/-sd] median   max
Connect:       38   46  18.1     43     196
Processing:    15   26  29.4     21     657
Waiting:       15   26  29.3     21     657
Total:         54   72  35.1     64     699
