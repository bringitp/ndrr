...
Time taken for tests:   15.712 seconds
Complete requests:      3500
Failed requests:        2943
   (Connect: 0, Receive: 0, Length: 2943, Exceptions: 0)
Non-2xx responses:      557
Total transferred:      13934778 bytes
HTML transferred:       12785621 bytes
Requests per second:    222.75 [#/sec] (mean)
Time per request:       89.786 [ms] (mean)
Time per request:       4.489 [ms] (mean, across all concurrent requests)
Transfer rate:          866.08 [Kbytes/sec] received

Connection Times (ms)
              min  mean[+/-sd] median   max
Connect:        3    6   3.7      5      37
Processing:     0   83  73.3     68     446
Waiting:        0   83  73.2     68     445
Total:          3   89  73.2     73     459
