...
## DRR駆動開発
![image](https://github.com/bringitp/ndrr/assets/141851166/64a773da-f9ba-40b0-a08e-62ab6cd0fcda)
...
# day 3 夕方から本気だす
## Oktaはアクティブトークン上限の無料枠が1000Tokensまでしかないらしく。nginxをリバプロにしてKeycloakを自前で建てる。 KeycloakのQiitaにある導入手法じゃだめで、Dockerイメージをそのまま動かすほうがよい。
